...
StyleSheet.create({
  ...
  stepActive: {},
  stepDot: { width: 28, height: 28, borderRadius: 14, backgroundColor: _C.border, alignItems: 'center', justifyContent: 'center' },
  stepDotActive: { backgroundColor: _C.primary },
  stepLabel: { fontSize: 10, color: _C.textLight, fontWeight: '600' },
  stepLabelActive: { color: _C.accent },
  title: { color: _C.text, fontSize: 20, fontWeight: '800', marginBottom: 6 },
  subtitle: { color: _C.textLight, fontSize: 13, marginBottom: 16 },
  label: { color: _C.textLight, fontSize: 12, fontWeight: '600', marginBottom: 6 },
  searchBox: { flexDirection: 'row', alignItems: 'center', backgroundColor: _C.card, borderRadius: 10, paddingHorizontal: 12, gap: 8, borderWidth: 1, borderColor: _C.border, marginBottom: 12 },
  searchInput: { flex: 1, color: _C.text, fontSize: 14, paddingVertical: 12 },
  resultCard: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: _C.card, borderRadius: 10, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: _C.border },
  resultName: { color: _C.text, fontSize: 14, fontWeight: '700' },
  resultSub: { color: _C.textLight, fontSize: 12 },
  selectedCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(108,43,217,0.15)', borderRadius: 10, padding: 14, marginBottom: 16, borderWidth: 1, borderColor: _C.primary },
  selectedName: { color: _C.text, fontSize: 15, fontWeight: '700' },
  selectedSub: { color: _C.textLight, fontSize: 12 },
  newClientBtn: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingVertical: 12 },
  newClientBtnText: { color: _C.accent, fontSize: 14, fontWeight: '600' },
  newClientForm: { backgroundColor: _C.card, borderRadius: 10, padding: 14, gap: 10, borderWidth: 1, borderColor: _C.border, marginBottom: 16 },
  input: { backgroundColor: _C.bg, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 10, color: _C.text, fontSize: 14, borderWidth: 1, borderColor: _C.border },
  createBtn: { backgroundColor: _C.primary, borderRadius: 8, paddingVertical: 12, alignItems: 'center' },
  createBtnText: { color: '#fff', fontSize: 14, fontWeight: '700' },
  nextBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: _C.primary, borderRadius: 12, paddingVertical: 14, marginTop: 20 },
  nextBtnText: { color: '#fff', fontSize: 15, fontWeight: '700' },
  dateRow: { flexDirection: 'row', gap: 12, marginBottom: 16 },
  searchVehicleBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: _C.accent, borderRadius: 10, paddingVertical: 12, marginBottom: 16 },
  searchVehicleBtnText: { color: '#fff', fontSize: 14, fontWeight: '700' },
  vehicleCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: _C.card, borderRadius: 10, padding: 14, marginBottom: 8, borderWidth: 1, borderColor: _C.border, gap: 10 },
  vehicleCardSelected: { borderColor: _C.success, backgroundColor: 'rgba(16,185,129,0.08)' },
  vehicleInfo: { flex: 1 },
  vehicleName: { color: _C.text, fontSize: 14, fontWeight: '700' },
  vehicleDetail: { color: _C.textLight, fontSize: 11, marginTop: 2 },
  vehiclePrice: { alignItems: 'flex-end' },
  priceNum: { color: _C.accent, fontSize: 16, fontWeight: '800' },
  priceLabel: { color: _C.textLight, fontSize: 10 },
  optionCard: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: _C.card, borderRadius: 8, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: _C.border },
  optionSelected: { borderColor: _C.success, backgroundColor: 'rgba(16,185,129,0.08)' },
  optionName: { flex: 1, color: _C.text, fontSize: 14 },
  optionPrice: { color: _C.textLight, fontSize: 12 },
  payCard: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: _C.card, borderRadius: 10, padding: 14, marginBottom: 8, borderWidth: 1, borderColor: _C.border },
  payCardActive: { borderColor: _C.primary, backgroundColor: 'rgba(108,43,217,0.1)' },
  payTitle: { color: _C.textLight, fontSize: 14, fontWeight: '700' },
  paySub: { color: _C.textLight, fontSize: 11, marginTop: 2 },
  summaryCard: { backgroundColor: _C.card, borderRadius: 12, padding: 16, borderWidth: 1, borderColor: _C.border, marginBottom: 20 },
  summaryRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 8 },
  summaryLabel: { color: _C.textLight, fontSize: 13 },
  summaryValue: { color: _C.text, fontSize: 13, fontWeight: '600' },
  divider: { height: 1, backgroundColor: _C.border, marginVertical: 8 },
  confirmBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: _C.success, borderRadius: 12, paddingVertical: 16 },
  confirmBtnText: { color: '#fff', fontSize: 16, fontWeight: '800' },
  successIcon: { marginBottom: 16 },
  successTitle: { color: _C.text, fontSize: 24, fontWeight: '800', marginBottom: 8 },
  successSub: { color: _C.textLight, fontSize: 15, marginBottom: 4 },
  successPrice: { color: _C.accent, fontSize: 28, fontWeight: '800', marginVertical: 12 },
  successMethod: { color: _C.textLight, fontSize: 14, marginBottom: 24 },
  newBookBtn: { backgroundColor: _C.primary, borderRadius: 12, paddingVertical: 14, paddingHorizontal: 32 },
