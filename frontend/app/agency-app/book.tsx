...
const s = StyleSheet.create({
  ...
  steps: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 24, borderRadius: 12, padding: 12, borderWidth: 1 },
  ...
  selectedCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(108,43,217,0.15)', borderRadius: 10, padding: 14, marginBottom: 16, borderWidth: 1 },
  ...
  nextBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, borderRadius: 12, paddingVertical: 14, marginTop: 20 },
  nextBtnText: { color: '#fff', fontSize: 15, fontWeight: '700' },
  dateRow: { flexDirection: 'row', gap: 12, marginBottom: 16 },
  searchVehicleBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, borderRadius: 10, paddingVertical: 12, marginBottom: 16 },
  searchVehicleBtnText: { color: '#fff', fontSize: 14, fontWeight: '700' },
  vehicleCard: { flexDirection: 'row', alignItems: 'center', borderRadius: 10, padding: 14, marginBottom: 8, borderWidth: 1, gap: 10 },
  vehicleCardSelected: {, backgroundColor: 'rgba(16,185,129,0.08)' },
  vehicleInfo: { flex: 1 },
  vehicleName: {, fontSize: 14, fontWeight: '700' },
  vehicleDetail: {, fontSize: 11, marginTop: 2 },
  vehiclePrice: { alignItems: 'flex-end' },
  priceNum: {, fontSize: 16, fontWeight: '800' },
  ...
  optionSelected: {, backgroundColor: 'rgba(16,185,129,0.08)' },
  optionName: { flex: 1, fontSize: 14 },
  optionPrice: {, fontSize: 12 },
  payCard: { flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: 10, padding: 14, marginBottom: 8, borderWidth: 1 },
  payCardActive: {, backgroundColor: 'rgba(108,43,217,0.1)' },
  payTitle: {, fontSize: 14, fontWeight: '700' },
  paySub: {, fontSize: 11, marginTop: 2 },
  summaryCard: {, borderRadius: 12, padding: 16, borderWidth: 1, marginBottom: 20 },
  summaryRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 8 },
  summaryLabel: {, fontSize: 13 },
  summaryValue: {, fontSize: 13, fontWeight: '600' },
  divider: { height: 1, marginVertical: 8 },
  confirmBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, borderRadius: 12, paddingVertical: 16 },
  ...
  newBookBtn: {, borderRadius: 12, paddingVertical: 14, paddingHorizontal: 32 },
