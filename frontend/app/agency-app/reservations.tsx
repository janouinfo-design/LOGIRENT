...
const s = StyleSheet.create({
  ...
  searchInput: { flex: 1, color: _C.text, fontSize: 14, paddingVertical: 10 },
  filterScroll: { maxHeight: 44, marginTop: 12 },
  filterContent: { paddingHorizontal: 16, gap: 8 },
  filterChip: { paddingHorizontal: 14, paddingVertical: 7, borderRadius: 20, backgroundColor: _C.card, borderWidth: 1, borderColor: _C.border },
  filterChipActive: { backgroundColor: _C.primary, borderColor: _C.primary },
  filterText: { color: _C.textLight, fontSize: 12, fontWeight: '600' },
  filterTextActive: { color: '#fff' },
  empty: { alignItems: 'center', paddingTop: 60, gap: 8 },
  emptyText: { color: _C.textLight, fontSize: 14 },
  ...
  clientName: { color: _C.text, fontSize: 15, fontWeight: '700' },
  badge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
  badgeText: { fontSize: 11, fontWeight: '700' },
  vehicleName: { color: _C.textLight, fontSize: 13, marginBottom: 8 },
  cardFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  dateText: { color: _C.textLight, fontSize: 12 },
  payInfo: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  payBadge: { fontSize: 11, fontWeight: '600' },
  price: { color: _C.accent, fontSize: 14, fontWeight: '700' },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.7)', justifyContent: 'flex-end' },
  modal: { backgroundColor: _C.card, borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 20, maxHeight: '70%' },
  modalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  modalTitle: { color: _C.text, fontSize: 18, fontWeight: '800' },
  modalSub: { color: _C.textLight, fontSize: 14, marginBottom: 4 },
  modalPrice: { color: _C.accent, fontSize: 20, fontWeight: '800', marginBottom: 16 },
  modalSection: { color: _C.textLight, fontSize: 12, fontWeight: '600', marginTop: 12, marginBottom: 8, textTransform: 'uppercase', letterSpacing: 1 },
  actionBtn: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 12, paddingHorizontal: 4, borderBottomWidth: 1, borderBottomColor: _C.border },
  actionText: { color: _C.text, fontSize: 14 },
