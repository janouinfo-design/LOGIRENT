...
const s = StyleSheet.create({
  ...
  filterText: { color: C.textLight, fontSize: 12, fontWeight: '600' },
  ...
  vehicleName: { color: C.textLight, fontSize: 13, marginBottom: 8 },
  cardFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  dateText: { color: C.textLight, fontSize: 12 },
  payInfo: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  payBadge: { fontSize: 11, fontWeight: '600' },
  price: { color: C.accent, fontSize: 14, fontWeight: '700' },
  ...
  modalSub: { color: C.textLight, fontSize: 14, marginBottom: 4 },
  modalPrice: { color: C.accent, fontSize: 20, fontWeight: '800', marginBottom: 16 },
  modalSection: { color: C.textLight, fontSize: 12, fontWeight: '600', marginTop: 12, marginBottom: 8, textTransform: 'uppercase', letterSpacing: 1 },
  actionBtn: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 12, paddingHorizontal: 4, borderBottomWidth: 1, borderBottomColor: C.border },
