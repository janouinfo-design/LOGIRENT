...
const s = StyleSheet.create({
  ...
  subtitle: { color: C.textLight, fontSize: 14, marginTop: 4, marginBottom: 20 },
  statsRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginBottom: 24 },
  statCard: { flex: 1, minWidth: 140, backgroundColor: C.card, borderRadius: 12, padding: 16, borderTopWidth: 3, alignItems: 'center', gap: 6 },
  statNum: { color: C.text, fontSize: 28, fontWeight: '800' },
  statLabel: { color: C.textLight, fontSize: 12 },
  sectionTitle: { color: C.text, fontSize: 18, fontWeight: '700', marginBottom: 14 },
  agencyCard: { backgroundColor: C.card, borderRadius: 12, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: C.border },
  ...
  agencyName: { color: C.text, fontSize: 16, fontWeight: '700' },
  ...
  gpsText: { color: C.info, fontSize: 11, fontWeight: '600' },
  agencyStats: { flexDirection: 'row', gap: 20 },
  agencyStat: { alignItems: 'center' },
  agencyStatNum: { color: C.text, fontSize: 22, fontWeight: '700' },
  agencyStatLabel: { color: C.textLight, fontSize: 11, marginTop: 2 },
});
