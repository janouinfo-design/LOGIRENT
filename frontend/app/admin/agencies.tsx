...
const styles = StyleSheet.create({
  ...
  linksRow: { flexDirection: 'row', gap: 10, marginTop: 14, borderTopWidth: 1, borderTopColor: COLORS.border, paddingTop: 14 },
  linkBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: 'rgba(167,139,250,0.08)', paddingVertical: 10, borderRadius: 10, borderWidth: 1, borderColor: COLORS.border },
  linkBtnText: { fontSize: 13, fontWeight: '600', color: COLORS.text },
