                ...
                <TouchableOpacity key={`dep-${event.id}`} style={styles.eventCard}
                  ...
                  <View style={{ flex: 1, padding: 10 }}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 2 }}>
                      <Ionicons name="time-outline" size={12} color={COLORS.departure} />
                      <Text style={{ fontSize: 12, fontWeight: '600', color: COLORS.departure }}>{format(new Date(event.start_date), 'HH:mm')}</Text>
                    </View>
