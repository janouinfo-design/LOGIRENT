...
const s = StyleSheet.create({
  ...
  imgBox: { height: 280, backgroundColor: C.card },
  img: { width: '100%', height: '100%' },
  imgPlaceholder: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: C.grayLight },
  ...
  year: { fontSize: 15, color: C.gray, marginTop: 2 },
  typeBadge: { backgroundColor: C.purple, paddingHorizontal: 14, paddingVertical: 6, borderRadius: 20 },
  ...
  locText: { fontSize: 14, color: C.gray },
  section: { marginTop: 24 },
  sectionTitle: { fontSize: 17, fontWeight: '700', color: C.dark, marginBottom: 12 },
  desc: { fontSize: 14, color: C.gray, lineHeight: 22 },
  specsRow: { flexDirection: 'row', gap: 12 },
  spec: { flex: 1, backgroundColor: C.card, borderRadius: 12, padding: 14, alignItems: 'center', borderWidth: 1, borderColor: C.border },
  specVal: { fontSize: 13, fontWeight: '600', color: C.dark, marginTop: 6, textTransform: 'capitalize' },
  specLbl: { fontSize: 11, color: C.gray, marginTop: 2 },
  // Calendar
  calCard: { backgroundColor: C.card, borderRadius: 14, padding: 16, borderWidth: 1, borderColor: C.border },
  calNav: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  calMonthLabel: { fontSize: 15, fontWeight: '700', color: C.dark },
  calWeekRow: { flexDirection: 'row', marginBottom: 4 },
  calWeekLabel: { flex: 1, textAlign: 'center', fontSize: 11, fontWeight: '600', color: C.gray, paddingVertical: 4 },
  ...
  calDayBooked: { backgroundColor: C.booked, borderRadius: 8 },
  calDayToday: { borderWidth: 2, borderColor: C.purple },
  calDayText: { fontSize: 13, color: C.dark },
  calDayTextBooked: { color: C.bookedText, fontWeight: '600', textDecorationLine: 'line-through' },
  calDayTextToday: { color: C.purple, fontWeight: '700' },
  calDayLine: { position: 'absolute', top: '50%', left: '20%', right: '20%', height: 1, backgroundColor: C.bookedText },
  calLegend: { flexDirection: 'row', justifyContent: 'center', gap: 16, marginTop: 12, paddingTop: 12, borderTopWidth: 1, borderTopColor: C.border },
  calLegendItem: { flexDirection: 'row', alignItems: 'center', gap: 5 },
  calLegendDot: { width: 8, height: 8, borderRadius: 4 },
  calLegendText: { fontSize: 11, color: C.gray },
  // Options
  optionItem: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: C.card, padding: 14, borderRadius: 12, marginBottom: 8, borderWidth: 1, borderColor: C.border },
  optionLeft: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  optionName: { fontSize: 14, color: C.dark },
  optionPrice: { fontSize: 13, fontWeight: '600', color: C.purple },
  // Bottom bar
  bottomBar: { position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: C.card, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 16, paddingBottom: 28, borderTopWidth: 1, borderTopColor: C.border },
  priceLbl: { fontSize: 11, color: C.gray },
  price: { fontSize: 22, fontWeight: '800', color: C.purple },
