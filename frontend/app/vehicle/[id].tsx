...
const s = StyleSheet.create({
  ...
  loading: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: _C.bg },
  loadingText: { color: _C.gray, fontSize: 14 },
  imgBox: { height: 280, backgroundColor: _C.card },
  img: { width: '100%', height: '100%' },
  imgPlaceholder: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: _C.grayLight },
  ...
  title: { fontSize: 24, fontWeight: '800', color: _C.dark },
  year: { fontSize: 15, color: _C.gray, marginTop: 2 },
  typeBadge: { backgroundColor: _C.purple, paddingHorizontal: 14, paddingVertical: 6, borderRadius: 20 },
  ...
  locText: { fontSize: 14, color: _C.gray },
  section: { marginTop: 24 },
  sectionTitle: { fontSize: 17, fontWeight: '700', color: _C.dark, marginBottom: 12 },
  desc: { fontSize: 14, color: _C.gray, lineHeight: 22 },
  specsRow: { flexDirection: 'row', gap: 12 },
  spec: { flex: 1, backgroundColor: _C.card, borderRadius: 12, padding: 14, alignItems: 'center', borderWidth: 1, borderColor: _C.border },
  specVal: { fontSize: 13, fontWeight: '600', color: _C.dark, marginTop: 6, textTransform: 'capitalize' },
  specLbl: { fontSize: 11, color: _C.gray, marginTop: 2 },
  // Calendar
  calCard: { backgroundColor: _C.card, borderRadius: 14, padding: 16, borderWidth: 1, borderColor: _C.border },
  calNav: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  calMonthLabel: { fontSize: 15, fontWeight: '700', color: _C.dark },
  calWeekRow: { flexDirection: 'row', marginBottom: 4 },
  calWeekLabel: { flex: 1, textAlign: 'center', fontSize: 11, fontWeight: '600', color: _C.gray, paddingVertical: 4 },
  ...
  calDayBooked: { backgroundColor: _C.booked, borderRadius: 8 },
  calDayToday: { borderWidth: 2, borderColor: _C.purple },
  calDayText: { fontSize: 13, color: _C.dark },
  calDayTextBooked: { color: _C.bookedText, fontWeight: '600', textDecorationLine: 'line-through' },
  calDayTextToday: { color: _C.purple, fontWeight: '700' },
  calDayLine: { position: 'absolute', top: '50%', left: '20%', right: '20%', height: 1, backgroundColor: _C.bookedText },
  calLegend: { flexDirection: 'row', justifyContent: 'center', gap: 16, marginTop: 12, paddingTop: 12, borderTopWidth: 1, borderTopColor: _C.border },
  calLegendItem: { flexDirection: 'row', alignItems: 'center', gap: 5 },
  calLegendDot: { width: 8, height: 8, borderRadius: 4 },
  calLegendText: { fontSize: 11, color: _C.gray },
  // Options
  optionItem: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: _C.card, padding: 14, borderRadius: 12, marginBottom: 8, borderWidth: 1, borderColor: _C.border },
  optionLeft: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  optionName: { fontSize: 14, color: _C.dark },
  optionPrice: { fontSize: 13, fontWeight: '600', color: _C.purple },
  // Bottom bar
  bottomBar: { position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: _C.card, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 16, paddingBottom: 28, borderTopWidth: 1, borderTopColor: _C.border },
  priceLbl: { fontSize: 11, color: _C.gray },
  price: { fontSize: 22, fontWeight: '800', color: _C.purple },
