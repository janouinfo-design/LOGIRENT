...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: '800', color: _C.dark },
  subtitle: { fontSize: 14, color: _C.gray, marginTop: 4 },
  filterBar: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  filterButtonText: { fontSize: 13, fontWeight: '600', color: _C.purple },
  filterBadge: {
  ...
  quickChip: {
    ...
    paddingVertical: 7,
    borderRadius: 18,
    backgroundColor: _C.grayLight,
    marginRight: 8,
  },
  quickChipActive: { backgroundColor: _C.purple },
  quickChipText: { fontSize: 13, fontWeight: '500', color: _C.gray },
  ...
  emptySubtext: { fontSize: 14, color: _C.gray, marginTop: 8 },
  modalContainer: { flex: 1, backgroundColor: _C.bg },
  modalHeader: {
    flexDirection: 'row',
  ...
  modalTitle: { fontSize: 20, fontWeight: '700', color: _C.dark },
  modalContent: { flex: 1, padding: 20 },
  filterSection: { marginBottom: 24 },
  filterLabel: { fontSize: 16, fontWeight: '600', color: _C.dark, marginBottom: 12 },
  ...
  filterOptionActive: { backgroundColor: _C.purple, borderColor: _C.purple },
  filterOptionText: { fontSize: 14, color: _C.dark },
