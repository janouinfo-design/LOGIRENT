...
const calStyles = StyleSheet.create({
  ...
  bookBtn: { flexDirection: 'row', alignItems: 'center', backgroundColor: C.purple, paddingHorizontal: 16, paddingVertical: 10, borderRadius: 20, marginTop: 12, gap: 6 },
  bookBtnText: { fontSize: 13, fontWeight: '600', color: '#FFF' },
  todayBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5, paddingVertical: 6, paddingHorizontal: 14, borderRadius: 16, borderWidth: 1, borderColor: C.purple, alignSelf: 'center', marginBottom: 8 },
  todayBtnText: { fontSize: 12, fontWeight: '600', color: C.purple },
