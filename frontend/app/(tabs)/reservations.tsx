...
const styles = StyleSheet.create({
  ...
  viewToggle: { flexDirection: 'row', borderRadius: 10, padding: 3 },
  toggleBtn: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8 },
  toggleBtnActive: { },
  filterBar: { flexDirection: 'row', flexWrap: 'wrap', borderBottomWidth: 1, paddingHorizontal: 16, paddingVertical: 8, gap: 6 },
  filterChip: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, borderWidth: 1.5, borderColor: '#E5E7EB', backgroundColor: '#FFFFFF' },
  ...
  vehicleThumbPlaceholder: { justifyContent: 'center', alignItems: 'center' },
  cardHeaderInfo: { flex: 1 },
  vehicleName: { fontSize: 15, fontWeight: '700' },
  vehicleYear: { fontSize: 11, marginTop: 1 },
  ...
  datesRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 10, borderTopWidth: 1, borderBottomWidth: 1 },
  dateBox: { flex: 1 },
  dateLabel: { fontSize: 10, marginBottom: 1 },
  dateValue: { fontSize: 13, fontWeight: '600' },
  dateTime: { fontSize: 11, fontWeight: '600', marginTop: 1 },
  dateArrow: { alignItems: 'center', paddingHorizontal: 10 },
  daysCount: { fontSize: 9, marginTop: 1 },
  ...
  cancelBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 10, paddingTop: 10, borderTopWidth: 1, gap: 5 },
...
const calStyles = StyleSheet.create({
  ...
  navBtn: { width: 36, height: 36, borderRadius: 10, justifyContent: 'center', alignItems: 'center', borderWidth: 1 },
  monthTitle: { fontSize: 17, fontWeight: '700', textTransform: 'capitalize' },
  weekRow: { flexDirection: 'row' },
  weekCell: { flex: 1, alignItems: 'center', paddingVertical: 6 },
  weekText: { fontSize: 11, fontWeight: '600', textTransform: 'uppercase' },
  ...
  legend: { flexDirection: 'row', justifyContent: 'center', gap: 16, paddingVertical: 12, borderTopWidth: 1, marginTop: 8 },
  legendItem: { flexDirection: 'row', alignItems: 'center', gap: 5 },
  legendDot: { width: 8, height: 8, borderRadius: 4 },
  legendText: { fontSize: 11 },
  selectedSection: { marginTop: 12, borderRadius: 12, padding: 14, borderWidth: 1 },
  selectedTitle: { fontSize: 15, fontWeight: '700', marginBottom: 10, textTransform: 'capitalize' },
  emptyDay: { alignItems: 'center', paddingVertical: 20 },
  emptyDayText: { fontSize: 13, marginTop: 6 },
  bookBtn: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 10, borderRadius: 20, marginTop: 12, gap: 6 },
  bookBtnText: { fontSize: 13, fontWeight: '600', color: '#FFF' },
  todayBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5, paddingVertical: 6, paddingHorizontal: 14, borderRadius: 16, borderWidth: 1, alignSelf: 'center', marginBottom: 8 },
  ...
  eventVehicle: { fontSize: 14, fontWeight: '600' },
  eventDates: { fontSize: 12, marginTop: 4 },
