...
const styles = StyleSheet.create({
  ...
  header: { paddingHorizontal: 20, paddingTop: 12, paddingBottom: 8, backgroundColor: _C.card },
  headerRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  title: { fontSize: 22, fontWeight: '800', color: _C.dark },
  subtitle: { fontSize: 13, color: _C.gray, marginTop: 2 },
  viewToggle: { flexDirection: 'row', backgroundColor: _C.grayLight, borderRadius: 10, padding: 3 },
  toggleBtn: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8 },
  toggleBtnActive: { backgroundColor: _C.purple },
  filterBar: { flexDirection: 'row', flexWrap: 'wrap', backgroundColor: _C.card, borderBottomWidth: 1, borderBottomColor: _C.border, paddingHorizontal: 16, paddingVertical: 8, gap: 6 },
  filterChip: { paddingHorizontal: 14, paddingVertical: 6, borderRadius: 16, backgroundColor: _C.grayLight },
  filterChipActive: { backgroundColor: _C.purple },
  filterText: { fontSize: 12, fontWeight: '500', color: _C.gray },
  filterTextActive: { color: '#FFF', fontWeight: '600' },
  scroll: { flex: 1 },
  content: { maxWidth: 800, width: '100%', alignSelf: 'center', padding: 16 },
  card: { backgroundColor: _C.card, borderRadius: 12, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: _C.border },
  cardHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 10, gap: 10 },
  vehicleThumb: { width: 40, height: 40, borderRadius: 8, overflow: 'hidden' },
  vehicleThumbPlaceholder: { backgroundColor: _C.grayLight, justifyContent: 'center', alignItems: 'center' },
  cardHeaderInfo: { flex: 1 },
  vehicleName: { fontSize: 15, fontWeight: '700', color: _C.dark },
  vehicleYear: { fontSize: 11, color: _C.gray, marginTop: 1 },
  ...
  datesRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 10, borderTopWidth: 1, borderBottomWidth: 1, borderColor: _C.border },
  dateBox: { flex: 1 },
  dateLabel: { fontSize: 10, color: _C.gray, marginBottom: 1 },
  dateValue: { fontSize: 13, fontWeight: '600', color: _C.dark },
  dateTime: { fontSize: 11, fontWeight: '600', color: _C.purple, marginTop: 1 },
  dateArrow: { alignItems: 'center', paddingHorizontal: 10 },
  daysCount: { fontSize: 9, color: _C.gray, marginTop: 1 },
  priceRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10 },
  priceBox: { alignItems: 'flex-end' },
  priceLabel: { fontSize: 10, color: _C.gray },
  priceValue: { fontSize: 18, fontWeight: '800', color: _C.purple },
  cancelBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 10, paddingTop: 10, borderTopWidth: 1, borderTopColor: _C.border, gap: 5 },
  cancelText: { fontSize: 12, fontWeight: '600', color: _C.error },
  emptyContainer: { alignItems: 'center', paddingTop: 60 },
  emptyText: { fontSize: 18, fontWeight: '600', color: _C.dark, marginTop: 16 },
  emptySubtext: { fontSize: 14, color: _C.gray, marginTop: 6 },
});

const calStyles = StyleSheet.create({
  monthNav: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  navBtn: { width: 36, height: 36, borderRadius: 10, backgroundColor: _C.card, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: _C.border },
  monthTitle: { fontSize: 17, fontWeight: '700', color: _C.dark, textTransform: 'capitalize' },
  weekRow: { flexDirection: 'row' },
  weekCell: { flex: 1, alignItems: 'center', paddingVertical: 6 },
  weekText: { fontSize: 11, fontWeight: '600', color: _C.gray, textTransform: 'uppercase' },
  dayCell: { flex: 1, alignItems: 'center', paddingVertical: 8, borderRadius: 8, minHeight: 44 },
  dayCellOutside: { opacity: 0.3 },
  dayCellToday: { backgroundColor: _C.purpleLight },
  dayCellSelected: { backgroundColor: _C.purple },
  dayNum: { fontSize: 14, fontWeight: '500', color: _C.dark },
  dayNumOutside: { color: _C.gray },
  dayNumToday: { fontWeight: '700', color: _C.purple },
  dayNumSelected: { color: '#FFF', fontWeight: '700' },
  dotsRow: { flexDirection: 'row', gap: 3, marginTop: 3 },
  dot: { width: 5, height: 5, borderRadius: 3 },
  legend: { flexDirection: 'row', justifyContent: 'center', gap: 16, paddingVertical: 12, borderTopWidth: 1, borderTopColor: _C.border, marginTop: 8 },
  legendItem: { flexDirection: 'row', alignItems: 'center', gap: 5 },
  legendDot: { width: 8, height: 8, borderRadius: 4 },
  legendText: { fontSize: 11, color: _C.gray },
  selectedSection: { marginTop: 12, backgroundColor: _C.card, borderRadius: 12, padding: 14, borderWidth: 1, borderColor: _C.border },
  selectedTitle: { fontSize: 15, fontWeight: '700', color: _C.dark, marginBottom: 10, textTransform: 'capitalize' },
  emptyDay: { alignItems: 'center', paddingVertical: 20 },
  emptyDayText: { fontSize: 13, color: _C.gray, marginTop: 6 },
  bookBtn: { flexDirection: 'row', alignItems: 'center', backgroundColor: _C.purple, paddingHorizontal: 16, paddingVertical: 10, borderRadius: 20, marginTop: 12, gap: 6 },
  bookBtnText: { fontSize: 13, fontWeight: '600', color: '#FFF' },
  todayBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5, paddingVertical: 6, paddingHorizontal: 14, borderRadius: 16, borderWidth: 1, borderColor: _C.purple, alignSelf: 'center', marginBottom: 8 },
  todayBtnText: { fontSize: 12, fontWeight: '600', color: _C.purple },
  eventCard: { flexDirection: 'row', backgroundColor: _C.bg, borderRadius: 10, marginBottom: 8, overflow: 'hidden' },
  eventBorder: { width: 4, alignSelf: 'stretch' },
  eventContent: { flex: 1, padding: 10 },
  eventHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  eventVehicle: { fontSize: 14, fontWeight: '600', color: _C.dark },
  eventDates: { fontSize: 12, color: _C.gray, marginTop: 4 },
  eventTimeRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 4 },
  eventTime: { fontSize: 13, fontWeight: '600', color: _C.purple },
  eventFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 6 },
  eventDays: { fontSize: 11, color: _C.gray },
  eventPrice: { fontSize: 15, fontWeight: '700', color: _C.purple },
});
