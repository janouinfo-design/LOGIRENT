...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://booking-hub-dev-4.preview.emergentagent.com')
...
class TestStripeCheckoutFlow:
    ...
    def test_checkout_initiation(self, api_client, vehicle_id):
        ...
        checkout_payload = {
            ...
            "origin_url": "https://booking-hub-dev-4.preview.emergentagent.com",
